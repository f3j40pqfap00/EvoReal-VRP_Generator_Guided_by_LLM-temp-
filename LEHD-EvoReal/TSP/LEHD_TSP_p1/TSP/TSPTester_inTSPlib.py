...
from LEHD_TSP_p1.TSP.TSPModel import TSPModel as Model
from LEHD_TSP_p1.TSP.TSPEnv_inTSPlib import TSPEnv as Env
from LEHD_TSP_p1.utils.utils import *
...
class TSPTester():
    ...
    def run(self):
        ...
        while episode < test_num_episode:
            ...
            elif 200<=problems_size<1000:
                problems_200_1000.append(current_gap)
            ...
            self.logger.info(f'problems_200_1000 mean gap:, {np.mean(problems_200_1000)},num problems:{len(problems_200_1000)}')
            ...
            if all_done:
                if not self.env_params['test_in_tsplib']:
                    ...
                    self.logger.info(" *** Test Done *** ")
                    all_result_gaps = problems_0_200 + problems_200_1000 + problems_1000_5000
