...
from LEHD_TSP_p1.TSP.test_TSPlib import main_test
from LEHD_TSP_p1.TSP.TSPEnv import TSPEnv as Env
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.trainer_params['epochs']+1):
            ...
            if all_done or (epoch % model_save_interval) == 0:
                ...
                torch.save(checkpoint_dict, '{}/p1-checkpoint-{}.pt'.format(self.result_folder, epoch))
