...
import logging
import numpy as np
from LEHD_CVRP_p1.utils.utils import create_logger
from LEHD_CVRP_p1.CVRP.Tester_inCVRPlib import VRPTester as Tester
...
RRC_budget = 10        # RRC budget

########### model ###############

model_load_path = 'result/20230817_235537_train'  # please download the pre-trained by your model in lehd's git
model_load_epoch = 40
...
test_paras = {
   # problem_size: [filename, episode, batch]
    ...
    0: ['setX_train.txt', 70, 1, 0 ] # full cvrplib set X problems
}
