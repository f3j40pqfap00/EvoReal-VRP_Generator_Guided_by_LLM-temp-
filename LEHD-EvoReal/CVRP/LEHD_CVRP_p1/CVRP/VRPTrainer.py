...
from LEHD_CVRP_p1.CVRP.VRPModel import VRPModel as Model
from LEHD_CVRP_p1.CVRP.test_setX import main_test
from LEHD_CVRP_p1.CVRP.VRPEnv import VRPEnv as Env
from LEHD_CVRP_p1.utils.utils import *
...
class VRPTrainer:
    ...
    def _train_one_batch(self, episode,batch_size,epoch):
        ...
        self.env.load_problems(episode,batch_size) # regeneate problems
        ...
        while not done:
            ...
            if current_step ==0:
                ...
                loss_node, selected_teacher, selected_student, selected_flag_teacher, selected_flag_student = \
                    self.model(state, self.env.selected_node_list, self.env.solution, current_step,
                               raw_data_capacity=self.env.batch_start_capacity)
            ...
            current_step+=1
            state, reward, reward_student, done = self.env.step(selected_teacher, selected_student,selected_flag_teacher,selected_flag_student)  # update selected_teacher list and mask
