...
from LEHD_CVRP_p1.CVRP.VRPEnv_inCVRPlib import VRPEnv as Env
            ...
            while not done:
                ...
                loss_node, selected_teacher, selected_student, selected_flag_teacher, selected_flag_student = \
                    self.model(state, self.env.selected_node_list, self.env.solution, current_step,
                               raw_data_capacity=self.env.raw_data_capacity)  # Update the selected points and probabilitiess
