...
model_load_path = 'result/p2-checkpoints'   # saved models from progressive finetuning
model_load_epoch = 9
...
test_paras = {
   # problem_size: [filename, episode, batch]
    ...
    0: ['setX.txt', 100, 1, 0 ]   # full cvrplib X problem set
}
...
def main_test(epoch,path,use_RRC=None,cuda_device_num=None):
    ...
    return score_optimal, score_student,gap, p100_200, p200_500, p500_1000
...
if __name__ == "__main__":
    ...
    for i in [model_load_epoch]:
        score_optimal, score_student,gap, p100_200, p200_500, p500_1000 = main_test(epoch=i,path=path)
        allin.append([ score_optimal, score_student,gap,  p100_200, p200_500, p500_1000])
